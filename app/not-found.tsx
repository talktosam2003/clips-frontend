...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-[#080C0B] text-white font-sans flex flex-col relative overflow-hidden">
      {/* Background ambient glows — matches home page style */}
      <div
        aria-hidden="true"
        className="fixed top-0 left-0 w-[700px] h-[700px] bg-brand/10 rounded-full blur-[150px] pointer-events-none -translate-x-1/2 -translate-y-1/2"
      />
      <div
        aria-hidden="true"
        className="fixed bottom-0 right-0 w-[600px] h-[600px] bg-brand/[0.06] rounded-full blur-[130px] pointer-events-none translate-x-1/3 translate-y-1/3"
      />
